    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="row col-md-12 mb-2 justify-content-center">
                    <button class="btn btn-primary btn-block col-sm-4" type="button" id="new_forum"><i class="fa fa-plus"></i> Create New Topic</button> <br><br>
                    <button class="btn btn-primary btn-block col-sm-4" type="button" id="civil_button"><i class="fa fa-plus"></i> Member List</button>

<script>
    // Add click event listener to the button
    document.getElementById("civil_button").addEventListener("click", function() {
        // Redirect to civillist23.php
        window.location.href = 'index.php?page=civillist23';
    });
</script>
                </div>   
            </div>
