                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="custom-select" name="role" required>
                                                    <option <?php echo $_SESSION['bio']['role'] =='Student' ? 'selected' : '' ?>>Student</option>
                                                    <option <?php echo $_SESSION['bio']['role'] =='Faculty' ? 'selected' : '' ?>>Faculty</option>
                                                    <option <?php echo $_SESSION['bio']['role'] =='Alumni' ? 'selected' : '' ?>>Alumni</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
