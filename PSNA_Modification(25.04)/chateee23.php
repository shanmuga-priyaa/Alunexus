    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="row col-md-12 mb-2 justify-content-center">
                    ...
                    <button class="btn btn-primary btn-block col-sm-4" type="button" id="eee_button"><i class="fa fa-plus"></i> Member List</button>

<script>
    document.getElementById("eee_button").addEventListener("click", function() {
        // Redirect to eeelist23.php
        window.location.href = 'index.php?page=eeelist23';
    });
</script>
                </div>   
            </div>
