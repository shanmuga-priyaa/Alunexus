    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="row col-md-12 mb-2 justify-content-center">
                    ...
                    <button class="btn btn-primary btn-block col-sm-4" type="button" id="cse_button"><i class="fa fa-plus"></i> Member List</button>
            </div>   
            </div>
...
<script>
    document.getElementById("cse_button").addEventListener("click", function() {
        // Redirect to cselist23.php
        window.location.href = 'index.php?page=cselist23';
    });
