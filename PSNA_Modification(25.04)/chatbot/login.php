...
<body style="background-color: #9BABB8;">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
       <center><h3 style="color:Black">Forum</h3></center>
            ...
            <div class="card-body">
                <form action="" id="login-form">
                    ...
                    <div class="form-group">
                        <label for="email" class="control-label">Email</label><br><br>
                        <input type="email" id="email" autofocus name="email" class="form-control form-control-sm rounded-0" required>
                    </div><br>
                    <div class="form-group">
                        <label for="password" class="control-label">Password</label><br><br>
                    ...
                    <div class="form-group d-flex w-100 justify-content-between">
                        ...
                        <button class="btn btn-sm btn-primary rounded-0 my-1" onclick="goBack()">Back</button>
                    </div>
                </form>
            </div>
        </div>
