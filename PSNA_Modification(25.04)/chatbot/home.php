    ...
    <div class="col-12 flex-grow-1">
        <div class="row h-100">
            <div class="col-md-4 h-100 d-flex flex-column">
                ...
                <div class="card shadow-lg rounded-0 flex-grow-1">
                    ...
                    <div class="list-group" id="convo_list">
                        ...
                        $convo_qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM user where id in (SELECT to_user FROM messages where from_user = '{$_SESSION['id']}') or id in (SELECT from_user FROM messages where to_user = '{$_SESSION['id']}')");
            ...
            <div class="col-md-8 h-100" id="right-panel">
                ...
                $qry = $conn->query("SELECT *,CONCAT(firstname,' ',middlename,' ',lastname) as fullname FROM  `user` where md5(id) = '{$eid}' ");
                if($qry->num_rows > 0):
